...
const defaultItems = [
    { title: "SafeVerified", subtitle: "Accredited", icon: ShieldCheck, colorClass: "group-hover:text-green-600" },
    { title: "TradeMaster", subtitle: "Guild Member", icon: Award, colorClass: "group-hover:text-yellow-500" },
    { title: "CheckaPro", subtitle: "5 Star Rated", icon: CheckCircle, colorClass: "group-hover:text-blue-500" }
];
